...
public:
    ...
    QVector<PhotonMapExportFactory*> getExportFactories() const {return m_exportFactories;}
    ...
    const QMap<QString, PhotonMapExportFactory*>& getExportMap() const {return m_exportMap;}
...
private:
    ...
    QMap<QString, PhotonMapExportFactory*> m_exportMap;
