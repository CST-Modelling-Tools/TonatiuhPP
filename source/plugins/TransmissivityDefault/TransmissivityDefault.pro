...
RESOURCES += src/TransmissivityDefault.qrc
TARGET        = TransmissivityDefault

CONFIG(debug, debug|release) {
    DESTDIR       = $$(TONATIUH_ROOT)/bin/debug/plugins/TransmissivityDefault  
}
else { 
    DESTDIR       = $$(TONATIUH_ROOT)/bin/release/plugins/TransmissivityDefault
}
