...
class ShapeTroughAsymmetricCPCFactory: public QObject, public TShapeFactory
{
    Q_OBJECT
...
public:
   	...
   	ShapeTroughAsymmetricCPC* CreateTShape( ) const;
   	bool IsFlat() { return false; }	 
   	
   	
};

#endif /*SHAPETROUGHASYMMETRICCPCFACTORY_H_*/
