...
RESOURCES += src/TransmissivityMirval.qrc
TARGET        = TransmissivityMirval

CONFIG(debug, debug|release) {
    DESTDIR       = $$(TONATIUH_ROOT)/bin/debug/plugins/TransmissivityMirval  
}
else { 
    DESTDIR       = $$(TONATIUH_ROOT)/bin/release/plugins/TransmissivityMirval
}
