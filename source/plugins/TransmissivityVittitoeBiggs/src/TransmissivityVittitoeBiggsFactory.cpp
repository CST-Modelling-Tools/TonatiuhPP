...
#include "TransmissivityVittitoeBiggsFactory.h"
...
TransmissivityVittitoeBiggs* TransmissivityVittitoeBiggsFactory::CreateTTransmissivity( ) const
{
	...
	if ( firstTime )
	{
		...
		TransmissivityVittitoeBiggs::initClass();
	    firstTime = false;
	}
	return new TransmissivityVittitoeBiggs;

}

#if QT_VERSION < 0x050000 // pre Qt 5
Q_EXPORT_PLUGIN2( TransmissivityVittitoeBiggs , TransmissivityVittitoeBiggsFactory )
#endif
