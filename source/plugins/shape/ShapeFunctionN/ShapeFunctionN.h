...
class ShapeFunctionN: public ShapeRT
{
    SO_NODE_HEADER(ShapeFunctionN);
...
public:
    ...
    NAME_ICON_FUNCTIONS("FunctionN", ":/ShapeFunctionN.png")
...
class ShapeFunctionNFactory:
    public QObject, public ShapeFactoryT<ShapeFunctionN>
{
    Q_OBJECT
