...
#include "TransmissivityVantHullFactory.h"
...
TransmissivityVantHull* TransmissivityVantHullFactory::CreateTTransmissivity( ) const
{
	...
	if ( firstTime )
	{
		...
		TransmissivityVantHull::initClass();
	    firstTime = false;
	}
	return new TransmissivityVantHull;

}

#if QT_VERSION < 0x050000 // pre Qt 5
Q_EXPORT_PLUGIN2( TransmissivityVantHull, TransmissivityVantHullFactory )
#endif
