...
{
	SO_NODE_HEADER( TransmissivityVantHull );
...
public:
	...
	trt::TONATIUH_REAL Visibility;
	trt::TONATIUH_REAL Site_Elevation;
	trt::TONATIUH_REAL Vapor_Density;
	trt::TONATIUH_REAL Tower_Heigth;

protected:
    virtual ~TransmissivityVantHull();
