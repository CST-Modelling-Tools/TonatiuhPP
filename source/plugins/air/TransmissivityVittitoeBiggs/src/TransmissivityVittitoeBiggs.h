...
class TransmissivityVittitoeBiggs : public TTransmissivity
{
	SO_NODE_HEADER( TransmissivityVittitoeBiggs );
...
protected:
    virtual ~TransmissivityVittitoeBiggs();

};

#endif /* TRANSMISSIVITYVITTITOEBIGGS_H_ */
