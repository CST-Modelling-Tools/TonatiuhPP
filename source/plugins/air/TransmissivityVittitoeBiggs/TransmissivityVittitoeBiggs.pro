...
RESOURCES += src/TransmissivityVittitoeBiggs.qrc
TARGET        = TransmissivityVittitoeBiggs

CONFIG(debug, debug|release) {
    DESTDIR       = $$(TONATIUH_ROOT)/bin/debug/plugins/TransmissivityVittitoeBiggs  
}
else { 
    DESTDIR       = $$(TONATIUH_ROOT)/bin/release/plugins/TransmissivityVittitoeBiggs
}
